...
const Aboutus = () => {
  ...
  return (
    <div className="mt-4">
      ...
      <h3 id="textH2">19 AÑOS JUNTO A ARTISTAS Y ARTESANOS UNA EXPERIENCIA QUE NOS GUSTA COMPARTIR </h3>
      ...
      <p id='textP'>Con el paso del tiempo y el avance de la tecnología ademas de continuar con las ediciones gráficas sumamos la difusión del mundo del arte en medios digitales.  Esta es nuestra historia junto a el Arte, y la seguimos escribiendo día a día junto a ustedes.</p>
